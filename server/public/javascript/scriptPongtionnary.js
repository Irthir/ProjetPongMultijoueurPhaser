...
function preload()
{
    ...
    this.load.image('BallMotion','pong/asset/sprite/BallMotion.png');
    this.load.image('Board','pong/asset/sprite/Board.png');
    this.load.image('Player1','pong/asset/sprite/Player1.png');
    this.load.image('Player2','pong/asset/sprite/Player2.png');
    this.load.image('ScoreBar','pong/asset/sprite/ScoreBar.png');
...
function update()
{
    ...
    else
    {
        ...
        if (ball.body.velocity.x > nPaddleSpeed)
        {
            ball.body.velocity.x = nPaddleSpeed;
        }
        else if (ball.body.velocity.x < -nPaddleSpeed)
        {
            ball.body.velocity.x = -nPaddleSpeed;
        }
    }
    ...
    else
    {
        ...
        {
            if (((this.input.activePointer.position.x)!= prevX || (this.input.activePointer.position.y)!=prevY) && path.curves.length<100)
            {
